...
MATLAB code accompanying "A specification discrepancy in the muscle filter of the Todorov–Jordan optimal feedback control model, and the convention that reproduces the published behavior" (submitted to *eNeuro*).
